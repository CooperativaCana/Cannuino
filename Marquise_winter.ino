...
char ssid[] = "XXXXX"; /// insert your network name here
char wifiPassword[] = "XXXXXX"; /// insert your router/device password here

/// generated by cayenne login in arduino Mega2560 with ESP8266, choosing "Arduino Mega > Arduino Mega ESP8266 Wifi"
/// https://cayenne.mydevices.com/cayenne/dashboard/arduino/your adress
